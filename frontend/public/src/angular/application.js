...
App.config(function($routeProvider) {
  $routeProvider.
    ...
    when('/profile/:nickname',  {controller:ProfileCtrl, templateUrl:'/src/views/profile.html'}).
    when('/world/:_id',         {controller:WorldCtrl, templateUrl:'/src/views/world.html'}).

    when('/home',               {controller:NavCtrl, templateUrl:'/src/views/home.html'}).
    when('/parents',            {controller:NavCtrl, templateUrl:'/src/views/parents.html'}).
